...
This project analyzes transactional data from a UK-based online retail business to investigate return order patterns, identify revenue drivers, examine customer retention by acquisition cohort, and surface actionable recommendations for offsetting revenue loss caused by high return volumes.
...
This UK-based online retail business is experiencing a high volume of returned orders, which is directly impacting total revenue. The root causes and patterns behind these returns are not yet fully understood, making it difficult for the business to take targeted corrective action. This analysis investigates return patterns across products, countries, and time, identifies where the business is generating its strongest revenue, and examines customer retention by acquisition cohort — so the business can make informed decisions on where to focus its efforts to offset the impact of returns.
...
| Q7 | How does customer retention vary by acquisition cohort? |
...
- **The December 2010 cohort** has the highest Month-1 retention rate at 38% — no subsequent cohort reached this level, with March 2011 recording the lowest Month-1 retention at 19%
...
On retention, the business should investigate what acquisition conditions drove the December 2010 cohort's superior Month-1 retention of 38% and replicate those conditions for future cohort acquisition, while reviewing and deprioritizing the strategies associated with lower-retention cohorts such as March 2011.
...
![Cohort Analysis](visuals/page4_cohort_analysis.png)
